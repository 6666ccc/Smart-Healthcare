"""WenRun 后端 HTTP 客户端，供 LangChain Tools 调用。"""
...
_client_logger = logging.getLogger("wenrun_ai.tools")


def _client() -> httpx.Client:
    return httpx.Client(
        base_url=base.get_wenrun_api_base_url(),
        headers=base.get_wenrun_auth_headers(),
        timeout=30.0,
    )
...
def api_request(
    ...
    try:
        ...
        return {"code": -1, "message": f"无法连接 WenRun 后端: {e}", "data": None}
