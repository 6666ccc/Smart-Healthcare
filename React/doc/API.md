# WenRun（温润）—— 门诊管理系统 API 文档

> 项目名称：WenRun（温润）—— 智能门诊管理系统
...
ai:
  service:
    ...
    api-key: wenrun-ai-internal-key-2026 # 内部 API Key
...
spring:
  application:
    name: WenRun
  datasource:
    url: jdbc:mysql://localhost:3306/wenrun?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai
    username: root
    password: 123456789

mybatis:
  mapper-locations: classpath:mapper/**/*.xml
  type-aliases-package: com.example.wenrun.entity
  configuration:
