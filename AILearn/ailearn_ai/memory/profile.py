...
与 huiliao_chat_memory（会话级）不同，用户画像按 user_id 维度存储，
...
from ailearn_ai.memory.embeddings import embed_query, get_vector_size
from ailearn_ai.memory.store import _get_client
from ailearn_ai.settings import base

_profile_logger = logging.getLogger("ailearn_ai.memory.profile")

PROFILE_COLLECTION = "huiliao_user_profile"
